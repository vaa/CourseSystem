...
<html>
	...
	<body>
		<div>
			<table class="table table-bordered table-hover">
		        ...
		        <c:forEach var="item" items="${sessionScope.teas }">
			    	...
			    	<td>${item.pwd }</td>
			    	<td>
			    		<a href="#" onclick="showDelete('${item.tno }')">删除 </a>
			    		<a href="#"onclick="showUpdate('${item.name }','${item.tno }','${item.pwd }')">修改 </a>
			    	</td>
			    	</tr>
		        </c:forEach>
		...
		<!-- 删除操作的模态框，对话框 -->
	<form action="/CourseSystem/DeleteTeacherServlet" method="post" class="form-horizontal">
       ...
       <form action="/CourseSystem/UpdateTeacherServlet"method="post"class="form-horizontal">
